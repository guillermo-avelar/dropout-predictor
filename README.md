# Predicting School Dropouts in El Salvador 🎒
...
│
├── pyproject.toml     <- Project configuration file with package metadata for dropout_predictor
...
│
└── dropout_predictor                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes dropout_predictor a Python module
    │
